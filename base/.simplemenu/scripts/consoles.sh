...
cat > ${consoles} <<EOF
[CONSOLES]
consoleList = NES,FDS,SNES,SATELLAVIEW,SUFAMI TURBO,MSU-1,SGB,VIRTUAL BOY,SEGA SG-1000,MASTER SYSTEM,SEGA GENESIS,MSU-MD,SEGA CD,SEGA 32X,ATARI 2600,ATARI 5200,ATARI 7800,INTELLIVISION,NEO GEO CD,PC ENGINE,PC ENGINE CD,PC-FX,PLAYSTATION,ODYSSEY2
